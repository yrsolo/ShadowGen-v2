...
echo [ShadowGen] Starting SELF-MANAGED worker container against cloud services...
echo [ShadowGen] This mode mounts the repository and Docker socket.
echo [ShadowGen] Use it only when you explicitly need in-container git update/rebuild actions.
