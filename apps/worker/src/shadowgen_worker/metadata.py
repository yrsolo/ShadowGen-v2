...
def collect_worker_version_info(repo_path: str, image_tag: str | None, container_name: str | None) -> WorkerVersionInfo:
    ...
    return WorkerVersionInfo(
        git_branch=os.environ.get("SHADOWGEN_GIT_BRANCH") or _git_value(["rev-parse", "--abbrev-ref", "HEAD"], effective_repo_path),
        git_commit=os.environ.get("SHADOWGEN_GIT_COMMIT") or _git_value(["rev-parse", "HEAD"], effective_repo_path),
        image_tag=image_tag,
